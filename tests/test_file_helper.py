...
def test_search_files_dummyextension_returns_non_empty_list():
    path = '/home/diego/git/jala/python/homeworks/demo2/test_files'
    extension = 'dummy'
...
def test_read_data_known_filenames_returns_non_empty_list():
    files = [
        '/home/diego/git/jala/python/homeworks/demo2/test_files/data_page_09012022000000.json',
        '/home/diego/git/jala/python/homeworks/demo2/test_files/data_page_09302022000000.json']
